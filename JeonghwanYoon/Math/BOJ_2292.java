...
public class BOJ_2292 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 방을 지나가는지(시작과 끝을 포함하여)를 계산하는 프로그램을 작성하시오. 예를 들면, 13까지는 3개, 58까지는 5개를 지난다.
		 * 
		...
		// 각 테두리의 최대값은 1 -> 7 -> 19 -> 37 -> 61 // 6 12 18 24 로 6배수만큼 커지므로 주어진 입력값이 어느 테두리 범위에 있는지 구해서 출력
		...
		// 2layer = 2~7  // 2+6 = 8
		// 3layer = 8~19 // 8+6*2 = 20
		// 4layer = 20~37 // 20+6*3 = 38
