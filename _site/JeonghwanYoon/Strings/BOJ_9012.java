...
public class BOJ_9012 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 
		 * 입력 
		 * 입력 데이터는 표준 입력을 사용한다. 입력은 T개의 테스트 데이터로 주어진다. 입력의 첫 번째 줄에는 입력 데이터의 수를 나타내는
		 * 정수 T가 주어진다. 각 테스트 데이터의 첫째 줄에는 괄호 문자열이 한 줄에 주어진다. 하나의 괄호 문자열의 길이는 2 이상 50
		 * 이하이다.
		 * 
		 * 출력 
		...
		// 풀이 : 스택에 좌괄호를 넣어서 마지막단계까지 좌괄호가 모두 사용되면 'YES' 좌괄호가 부족하거나 남는경우 'NO'
