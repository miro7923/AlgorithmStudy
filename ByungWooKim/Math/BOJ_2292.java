 ...
 *
 * # 풀이
 * 벌집의 형태를 보면 각 층(?)마다 방의 개수는 등비수열을 이룬다.
 ...
 * 공비가 6인 등비수열이라는 것을 이용하여 코드를 구성했다.
 *
 *
 */
...
public class BOJ_2292 {
    ...
    static int countRoom() {
        ...
        int standard = 6;
        while (true) {
            standard += 6 * count;  // 기준값은 공비인 6과 지나가야하는 방의 수 count를 더한 값을 계속 더한다.
            count++;
        ...
        // 기준값은 6 -> 12 -> 18 이런식으로 증가하다가 18이 되면 17인 N보다 크기 때문에 while문을 종료한다.
        // count의 값은 2(기준값이 변한 횟수) + 1인 즉 3이 된다.
